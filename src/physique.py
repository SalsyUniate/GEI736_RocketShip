...
class Rocket:
	def __init__(self, space, w,h):
		...
		self.props[0].shape = self.props[0].shape @ pymunk.Transform.rotation(self.forceangle[0]).translation(self.forcepos[0])
		self.props[1].shape = self.props[1].shape @ pymunk.Transform.rotation(self.forceangle[1]).translation(self.forcepos[1])
